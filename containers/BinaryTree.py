...
class BinaryTree():
    ...
    def to_list(self, traversal_type):
        ...
        them. But by returning the results we can also do more computations
    ...
    def __len__helper(node):
        ...
        if a left child exists, add the result of __len__helper on
        the left child;
        if a right child exists, add the result of __len__helper on
        the right child;
